...
It made sense to break `BitcoinCash` apart and at the heart of v0.4.0 is 3 new classes which separate methods meaningfully bringing more functionality to BITBOX and which make it easier for you to create great $BCH apps.
...
Also included in `BITBOX.Mnemonic` helper methods for validating mnemonics, finding the nearest word in a mnemonic wordlist and generating public address/private key WIF pairs.
