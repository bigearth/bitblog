...
BITBOX `Script` can now encode/decode and check the format of inputs/outputs for P2PK, P2PKH, P2MS, P2SH and nullData transactions as well as supporting all the new OP codes. Next stop May 15th!
